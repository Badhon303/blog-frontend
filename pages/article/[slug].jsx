import { fetchArticleBySlug, urlBackend } from "../../api"
import qs from "qs"
    ...
    <>
      ...
      <div className="my-12 grid md: grid-cols-3 gap-12">
        <div className="col-span-2">
          ...
          <div className="text-lg text-grey-600 leading-8">
            <img
              src={`${urlBackend}${article.attributes.Image.data.attributes.url}`}
...
export const getServerSideProps = async ({ query }) => {
  const queryString = qs.stringify({
    populate: ["Image", "users_permissions_user.image"],
    filters: {
      Slug: {
        $eq: query.slug,
      },
  ...
  const { data: article } = await fetchArticleBySlug(queryString)
